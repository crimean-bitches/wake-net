namespace Wake
{
    ...
    {
        public const string NotInitialized = "Calling methods on not initialized instance of WakeNet. Call WakeNet.Init() first.";
        ...
        public const string DiscoveryNotExists = "Discovery you wish to operate not exists or already has been destroyed.";
